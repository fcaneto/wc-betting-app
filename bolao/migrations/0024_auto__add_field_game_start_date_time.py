...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.start_date_time'
        db.add_column(u'bolao_game', 'start_date_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.start_date_time'
        db.delete_column(u'bolao_game', 'start_date_time')

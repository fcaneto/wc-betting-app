...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BetRoom.is_open_to_betting'
        db.add_column(u'bolao_betroom', 'is_open_to_betting',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BetRoom.is_open_to_betting'
        db.delete_column(u'bolao_betroom', 'is_open_to_betting')

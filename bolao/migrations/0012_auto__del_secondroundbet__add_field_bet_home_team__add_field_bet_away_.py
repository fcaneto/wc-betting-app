...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'SecondRoundBet'
        db.delete_table(u'bolao_secondroundbet')

        # Adding field 'Bet.home_team'
        db.add_column(u'bolao_bet', 'home_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='home_bets', null=True, to=orm['bolao.Team']),
                      keep_default=False)

        # Adding field 'Bet.away_team'
        db.add_column(u'bolao_bet', 'away_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='away_bets', null=True, to=orm['bolao.Team']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding model 'SecondRoundBet'
        db.create_table(u'bolao_secondroundbet', (
            ('away_team', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='away_bets', null=True, to=orm['bolao.Team'])),
            ('home_team', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='home_bets', null=True, to=orm['bolao.Team'])),
            ('winner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolao.Team'], null=True)),
            (u'bet_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bolao.Bet'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'bolao', ['SecondRoundBet'])

        # Deleting field 'Bet.home_team'
        db.delete_column(u'bolao_bet', 'home_team_id')

        # Deleting field 'Bet.away_team'
        db.delete_column(u'bolao_bet', 'away_team_id')

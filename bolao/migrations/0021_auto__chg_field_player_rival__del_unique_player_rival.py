...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Player', fields ['rival']
        db.delete_unique(u'bolao_player', ['rival_id'])


        # Changing field 'Player.rival'
        db.alter_column(u'bolao_player', 'rival_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolao.Player'], null=True))

    def backwards(self, orm):

        # Changing field 'Player.rival'
        db.alter_column(u'bolao_player', 'rival_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bolao.Player'], unique=True, null=True))
        # Adding unique constraint on 'Player', fields ['rival']
        db.create_unique(u'bolao_player', ['rival_id'])
    ...
    models = {
        ...
        u'bolao.betroom': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_open_to_betting': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'bolao.player': {
            ...
            'bet_room': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bolao.BetRoom']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rival': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bolao.Player']", 'null': 'True'}),
            'rival_correlation': ('django.db.models.fields.FloatField', [], {'null': 'True'}),

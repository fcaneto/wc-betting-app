...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Bet.player'
        db.alter_column(u'bolao_bet', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bolao.Player']))

    def backwards(self, orm):

        # Changing field 'Bet.player'
        db.alter_column(u'bolao_bet', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

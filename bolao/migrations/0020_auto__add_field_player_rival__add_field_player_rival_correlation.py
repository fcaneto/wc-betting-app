...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.rival'
        db.add_column(u'bolao_player', 'rival',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['bolao.Player'], unique=True, null=True),
                      keep_default=False)

        # Adding field 'Player.rival_correlation'
        db.add_column(u'bolao_player', 'rival_correlation',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.rival'
        db.delete_column(u'bolao_player', 'rival_id')

        # Deleting field 'Player.rival_correlation'
        db.delete_column(u'bolao_player', 'rival_correlation')
    ...
    models = {
        ...
        u'bolao.player': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rival': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bolao.Player']", 'unique': 'True', 'null': 'True'}),

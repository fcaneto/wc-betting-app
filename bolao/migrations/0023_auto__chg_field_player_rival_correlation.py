...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.rival_correlation'
        db.alter_column(u'bolao_player', 'rival_correlation', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Player.rival_correlation'
        db.alter_column(u'bolao_player', 'rival_correlation', self.gf('django.db.models.fields.TextField')(max_length=10, null=True))
    ...
    models = {
        ...
        u'bolao.player': {
            ...
            'rival_correlation': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
